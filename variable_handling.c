...
/**
 * check_env - Checks if the given input corresponds
 * to an environment variable.
 * @h: Pointer to the head of the environment variable linked list.
...
/**
 * check_vars - Checks for variables in the input string
 * and replaces them with their values.
 * @h: Pointer to the head of the variable linked list.
 * @in: Input string to check.
 * @st: String representation of the current process ID.
 * @data: Pointer to the data_shell structure.
...
/**
 * rep_var - Replaces variables in the input

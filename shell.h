...
/**
 * struct data - Structure to hold shell data.
 ...
 * @counter: Counter for command execution.
 ...
 * Description: Used to tokenize user input based on separators.
 */
 ...
 * @line: String representing a line of user input.
 * @next: Pointer to the next line node.
 * Description: Used to store individual lines of user input.
 */
 ...
 * Description: Used to manage shell variables.
 */

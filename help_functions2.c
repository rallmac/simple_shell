...
/**
 * aux_help_env - Displays help information
...
/**
 * aux_help_setenv - Displays help information
 * about the 'setenv' command.
 * Return: None.
 */
void aux_help_setenv(void)
{
	char *help = "setenv:(const char *name, const char *value, int replace)\n\t";
...
/**
 * aux_help_unsetenv - Displays help information
 * about the 'unsetenv' command.
 * Return: None.
 */
...
void aux_help_general(void)
{
	...
	write(STDOUT_FILENO, help, _strlen(help));
	help = "commands are defined internally. Type 'help' to see the list.\n";
	write(STDOUT_FILENO, help, _strlen(help));

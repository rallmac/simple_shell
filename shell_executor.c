 ...
 * @input: Input string.
 * @bool: Boolean flag indicating the direction of swapping.
...
/**
 * add_nodes - Adds separator nodes and line nodes to the respective lists.
...
/**
 * go_next - Moves to the next node based on the current status and separator.
...
/**
 * split_commands - Splits input commands into tokens and executes them.
 * @datash: Pointer to the data_shell struct.
 * @input: Input string.

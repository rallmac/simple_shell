...
/**
 * cd_dot - Changes the current working directory to the
 * parent directory or remains in the same directory.
...
/**
 * cd_to - Changes the current working directory
...
/**
 * cd_previous - Changes the current working directory
...
/**
 * cd_to_home - Changes the current working directory
